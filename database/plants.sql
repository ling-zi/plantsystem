...
alter table fk_role_has_permission add constraint FK_fk_role_has_permission foreign key (角色ID)
      references roles (角色ID) on delete restrict on update restrict;
...
alter table fk_user_has_role add constraint FK_fk_user_has_role2 foreign key (角色ID)
      references roles (角色ID) on delete restrict on update restrict;
