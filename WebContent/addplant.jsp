...
<div>
	...
	<div id="main_content">
		<div id="main_content01">
			<div>
				<form action="<%=request.getContextPath() %>/plant?type=add" method="post" class="form-horizontal">
					...
					<div style="margin-left:210px">
						...
						<div class="form-group">
							<textarea name="pdesc" style="width:700px;" class="form-control" rows="5" placeholder="请输入植物描述"></textarea>
						</div>
