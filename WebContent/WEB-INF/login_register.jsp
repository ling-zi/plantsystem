	...
	<div id="div00">
		...
		<div>
			<div class="page-header"
				...
				<img style="width: 300px; height: 120px;" src="image/logo.png" />
			</div>
		</div>
		...
		<div id="div01">
			...
			<div id="div02" name="right">
				<div id="login_div">
					...
					<form action="<%=request.getContextPath()%>/myLogin?type=login"
						method="post">
					...
					<!--
                        	...
                        	描述：注册信息输入框
                        -->
					<form action="<%=request.getContextPath()%>/myLogin?type=register"
						method="post">
